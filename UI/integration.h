...
private:
    ...
    void on_btnEditPowerPresetsStage_clicked();    // 编辑电控平台与功率预设（位移台页）
    void on_btnEditDelayPresets_clicked();         // 编辑延迟线预设（位移台页）
    
    // 编辑弹窗辅助方法
    void showPowerPresetEditDialog();              // 显示功率预设编辑弹窗
    void showDelayPresetEditDialogGalvo();         // 显示延迟预设编辑弹窗（振镜页）
    void showPowerPresetEditDialogStage();         // 显示功率预设编辑弹窗（位移台页）
    void showDelayPresetEditDialog();              // 显示延迟预设编辑弹窗（位移台页）
};
